      ...
      <div className="group" data-highlighter>
        <div
          className={cn(
            ...
            finalizedDataNftIdentifier
              ? ' bg-[#35d9fa]/40   dark:bg-[#35d9fa]/20'
              : '',
          )}
        >
          {finalizedDataNftIdentifier && (
          ...
          <div className="relative h-full bg-neutral-950/40 dark:bg-neutral-950/60  rounded-[inherit] z-20 overflow-hidden p-4 md:p-8">
            ...
            <>
              ...
              <div className="mb-3 py-1 border-b-4 border-[#35d9fa]/30">
                Submitted On:{' '}
                {moment(submittedOnTs * 1000).format('YYYY-MM-DD')}
              </div>
              ...
              {address && finalizedDataNftIdentifier ? (
                <div className="h-[21rem]">
                  ...
                  />
                  <div className="text-center text-2xl bg-[#2495AC] dark:bg-[#022629] p-1 px-3 rounded-2xl shadow-inner shadow-[#35d9fa]/30">
                    Finalized
                  </div>
                </div>
              ) : (
              ...
              {!finalizedDataNftIdentifier ? (
                <Link
                  href="https://docs.google.com/forms/d/e/1FAIpQLSctQIpxSw-TnJzP52nUddJEun28DUcObqbUGH8ulHEd0MNmaQ/viewform?usp=sf_link"
                  target="_blank"
                ...
                <div className="flex flex-row gap-2 justify-between items-center">
                  <div className="text-center items-center bg-[#2495AC] dark:bg-[#022629] p-1 px-3 rounded-2xl shadow-inner shadow-[#35d9fa]/30">
                    Finalized
                  </div>
                </div>
              ) : (
