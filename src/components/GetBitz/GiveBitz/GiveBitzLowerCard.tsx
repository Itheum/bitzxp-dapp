...
import bitzLogo from '../../../../public/getbitz/givebitz/flaskBottle.png';
...
const GiveBitzLowerCard: React.FC<GiveBitzLowerCardProps> = (props) => {
  ...
  async function handlePowerUp() {
    ...
    if (_isPowerUpSuccess) {
      const _bitzGivenToCreator =
        bitzGivenToCreator >= 0 ? bitzGivenToCreator + bitzSent : bitzSent;
      ...
      <div className="h-[18rem]">
        <div className=" items-center gap-2   my-rank-and-score  flex  justify-center   p-[.6rem] mb-[1rem] rounded-[1rem] text-center bg-[#35d9fa] bg-opacity-25">
          ...
          <p className="text-lg md:text-xl dark:text-[#35d9fa] font-bold">
            {bitzGivenToCreator === -1 ? (
              'Loading...'
            ) : (
              <>{bitzGivenToCreator === -2 ? '0' : bitzGivenToCreator}</>
            )}
          </p>
        </div>
        ...
        <div
          id={'canvas-' + bountyId}
          className="flex flex-col items-center justify-between w-full h-[75%] relative"
        >
          <motion.div
          ...
          >
            <p>
              {' '}
              Share your support for the bounty! Tweet about your contribution
              and help spread the word.
            </p>

            <button
              onClick={() => setIsPowerUpSuccess(false)}
              className=" justify-end z-10 ml-auto"
            >
            ...
            <div className="mb-3 mt-1 w-full">
              <div className="flex flex-row gap-2 justify-center items-center">
                ...
                <input
                  ...
                  value={bitzVal}
                  onChange={(e) =>
                    setBitzVal(Math.min(Number(e.target.value), bitzBalance))
                  }
