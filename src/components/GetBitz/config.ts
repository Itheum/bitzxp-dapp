...
export function getCreatorCampaigns() {
  ...
  if (process.env.NEXT_PUBLIC_ENV_NETWORK === EnvironmentsEnum.devnet) {
    allCreatorCampaigns.push({
      ...
      campaignPerks:
        'Top 20 Leaderboard gets my latest Data NFT. 10 Data NFTs to be dropped to random winners of top 100 Leaderboard.',
    });
    ...
    allCreatorCampaigns.push({
      creatorAddress:
        'erd16vjhrga4yjpy88lwnu64wlxlapwxtvjl93jax4rg3yq3hzxtnausdmhcjf',
      campaignId: 'c3',
      campaignStartTs: 1712713989,
      campaignEndTs: 1715305989,
      campaignPerks:
...
export function getDataBounties() {
  ...
  if (process.env.NEXT_PUBLIC_ENV_NETWORK === EnvironmentsEnum.devnet) {
    ...
    allBounties.push({
      bountySubmitter:
        'erd1x4xtwphcnx254gc0c3yuur98vyveh4s99se45qvqmugcgu27ahjsuvf95r',
      bountyId: 'b7',
    ...
    allBounties.push({
      bountySubmitter:
        'erd1c7jg5lkfjxsk0y32td5z2f4edh7r8u0pwy0k67evzmeem3gzwdxsvlukc0',
      bountyId: 'b8',
